...
int main(int argc, char* argv[])
{
    ...
    else
    {
        ...
        if (!PostThreadMessage(mainThreadId, WM_KEYFIRST, (WPARAM)localhigherCounter, (LPARAM)locallowerCounter))
            std::cout << GetLastError() << " PostThreadMessage error (KEYFIRST)\n";

        if (!PostThreadMessage(mainThreadId, WM_KEYLAST, (WPARAM)localhigherCounter, (LPARAM)locallowerCounter))
            std::cout << GetLastError() << " PostThreadMessage error (KEYLAST)\n";
